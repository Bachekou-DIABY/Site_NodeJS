                ...
                if (document.getElementById("c0593d70-acff-41c7-b7b3-fdef1878ebe5")) {
                    Plotly.newPlot("c0593d70-acff-41c7-b7b3-fdef1878ebe5", [{ "hovertemplate": "primary_fuel=%{x}<br>estimated_generation_gwh_2017=%{y}<extra></extra>", "legendgroup": "", "line": { "color": "#636efa", "dash": "solid" }, "marker": { "symbol": "circle" }, "mode": "lines", "name": "", "orientation": "v", "showlegend": false, "x": ["Biomass", "Coal", "Cogeneration", "Gas", "Geothermal", "Hydro", "Nuclear", "Oil", "Other", "Petcoke", "Solar", "Storage", "Waste", "Wind"], "xaxis": "x", "y": [0.0, 1150861.91, 0.0, 1926994.19, 21022.26, 300321.72, 826910.84, 21764.48, 11288.300000000001, 0.0, 73706.07, 0.0, 1766.91, 318528.56], "yaxis": "y", "type": "scatter" }, { "mode": "lines", "name": "France", "x": ["Biomass", "Coal", "Gas", "Geothermal", "Hydro", "Nuclear", "Oil", "Solar", "Wave and Tidal", "Wind"], "y": [0.0, 16319.68, 20143.83, 0.0, 64022.1, 381718.79, 4693.46, 8348.26, 0.0, 16569.98], "type": "scatter" }], {
                        ...
                        "title": { "text": "Estimated Electricity Generation in 2017 In France and USA" }
                    }, { "responsive": true })
                };