...
if (document.getElementById("233e83f6-c44c-4425-9cc9-241219ab49ae")) {
    Plotly.newPlot("233e83f6-c44c-4425-9cc9-241219ab49ae", [{
        "customdata": [
            ["Nucl\\u00e9aire"],
            ["Charbon"],
            ["Gaz"],
        ...
        "hovertemplate": "Filieres=%{customdata[0]}<br>Pourcentage=%{value}<extra></extra>",
        "labels": ["Nucl\\u00e9aire", "Charbon", "Gaz", "Fioul", "Hydraulique", "Eolien", "Solaire"],
        "legendgroup": "",
        "marker": { "colors": ["orange", "black", "green", "red", "blue", "cyan", "yellow"] },
        "name": "",
        "showlegend": true,
        "values": [58.0, 1.0, 12.7, 0.30000000000000004, 22.9, 4.7, 0.4],
        "type": "pie"
    }], {
        "template": {
            "data": {
        ...
        "title": { "text": "Production of electricity by fuel type in France" },
        "plot_bgcolor": "rgb(10,105,10)"
    }, { "responsive": true })
};